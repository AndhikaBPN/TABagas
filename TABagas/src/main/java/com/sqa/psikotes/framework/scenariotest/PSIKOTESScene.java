...
public enum PSIKOTESScene {
	...
	B15("TSDU008002 Admin edit status user NON ACTIVE menjadi ATCIVE"),//1
	...
	B20("TSDU008007 Admin edit kategori dengan menghilangkan centang kategori STAFF di status Admin NON ACTIVE"),//1
	B21("TSDU008008 Admin edit kategori dengan menghilangkan centang kategori LEADER di status Admin NON ACTIVE"),//1
	B22("TSDU008009 Admin edit kategori dengan menghilangkan centang kategori STAFF dan LEADER di status Admin NON ACTIVE");//1
